    ...
    <nav class="navbar">
        <div class="nav-container">
            ...
            <ul class="nav-links">
                ...
                <li><a href="comprar.php" class="nav-link">Consultar</a></li>
            </ul>
        </div>
    </nav>
    ...
    <div class="container">
        ...
        <div class="contact-grid">
            ...
            <div class="contact-form">
                ...
                <form id="consultaForm" action="enviar-formulario.php" method="POST">

                    <div class="form-grid">
                        <div class="form-group">
                            <label class="form-label">Nombre</label>
                            <input type="text" class="form-input" id="firstName" name="firstName" placeholder="Nombre" required>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Apellido</label>
                            <input type="text" class="form-input" id="lastName" name="lastName" placeholder="Apellido" required>
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="form-label">Email</label>
                        <input type="email" class="form-input" id="email" name="email" placeholder="correo@ejemplo.com" required>

                    </div>

                    <div class="form-group">
                        <label class="form-label">Teléfono</label>
                       <input type="tel" class="form-input" id="phone" name="phone" placeholder="+54 376 4123456" required>
                    </div>

                    <div class="form-group">
                        <label class="form-label">Dirección</label>
                        <input type="text" class="form-input" id="address" name="address" placeholder="Calle, número, ciudad, provincia" required>
                    </div>

                    <div class="form-group">
                        <label class="form-label">Asunto</label>
                        <input type="text" class="form-input" id="subject" name="subject" placeholder="Motivo de la consulta" required>
                    </div>

                    <div class="form-group">
                        <label class="form-label">Mensaje</label>
                        <textarea class="form-textarea" id="message" name="message" placeholder="Describa brevemente su consulta..." required></textarea>
                    </div>
